...
- Local NuxtHub API tests run against libSQL and do not exercise Drizzle's D1 batch driver. D1-specific batch workarounds therefore require a focused D1-driver regression test in addition to the normal API behavior tests.
